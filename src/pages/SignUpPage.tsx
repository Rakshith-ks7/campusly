...
export const SignUpPage: React.FC = () => {
  ...
  const getFriendlyErrorMessage = (err: any): string => {
    ...
    if (code === 'auth/invalid-email') {
      return 'Please enter a valid university or student email address.';
    }
    ...
    return err?.message || 'Unable to create account. Please check your details and try again.';
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Success: redirect to onboarding to fill campus profile
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md space-y-4 text-center">
        ...
        <div className="space-y-1">
          <h2 className="font-heading font-bold text-2xl sm:text-3xl text-[#262626]">
            Join <span className="text-[#E63946]">Campusly</span>
          </h2>
          <p className="text-xs sm:text-sm text-[#666666]">
            Create your account to discover college teammates, study partners, and campus communities
          </p>
        </div>
      </div>
      ...
      <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white border border-[#E5E5E5] rounded-2xl p-6 sm:p-8 shadow-xs space-y-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <User className="w-4 h-4 text-[#999999] absolute left-3 top-3" />
                <input
                  type="text"
                  required
                  value={name}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="name@campus.edu or student email"
                  className="w-full bg-[#FFF8F8] border border-[#E5E5E5] rounded-xl pl-9 pr-3 py-2.5 text-xs sm:text-sm text-[#262626] focus:outline-none focus:border-[#FECDD3] focus:ring-1 focus:ring-[#FECDD3]"
                />
              </div>
            </div>
          ...
          <div className="text-center pt-2">
            <span className="text-xs text-[#666666]">Already have a Campusly account? </span>
            <Link to="/login" className="text-xs font-semibold text-[#E63946] hover:underline">
              Log in here
            </Link>
          </div>
